...
function faceShapeToText(val) { if (val === "round") return "Rond"; if (val === "oval") return "Ovale"; if (val === "squarechin") return "Menton Carré"; if (val === "rectchin") return "Menton Rectangulaire"; return "Rond" }
function hairTypeToText(val) { if (val === "short") return "Court"; if (val === "bangs") return "Bangs"; if (val === "beatles") return "Beatles"; if (val === "long") return "Long"; if (val === "mickey") return "Mickey"; if (val === "semi-long") return "Semi-Long"; if (val === "longcurly") return "Long Bouclé"; if (val === "lox") return "Locks"; if (val === "medium") return "Medium"; if (val === "curly") return "Bouclé"; if (val === "ponytail") return "Queue de cheval"; return "Mickey" }
function eyeTypeToText(val) { if (val === "normal") return "Normaux"; if (val === "happy") return "Heureux"; if (val === "wink") return "Clin d'oeil"; if (val === "glasses") return "Lunettes"; if (val === "angry") return "Énervé"; if (val === "kawaii") return "Kawaii"; if (val === "sunglasses") return "Solaire"; if (val === "crying") return "Pleur"; return "Heureux" }
function mouthTypeToText(val) { if (val === "smile") return "Sourire"; if (val === "open") return "Normal"; if (val === "sad") return "Triste"; if (val === "line") return "Ligne"; if (val === "none") return "Aucune"; if (val === "surprised") return "Surpris"; return "Sourire" }
...
document.body.addEventListener('click', e => {
  if (avatarMenu.style.display === 'block' && !avatarMenu.contains(e.target) && !customizeAvatarBtn.contains(e.target) && !mainMenu.contains(e.target)) {
