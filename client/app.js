...
function createListItem(id, container, isPinned) {
  ...
  li.innerHTML = '<div class="user-item"><div class="user-avatar">' + generateAvatarSVG(avatarMap[id], 30) + '</div><div class="user-info-box"><div class="user-name">' + name + '</div>' + statusHTML + '</div><span class="notif" style="display:none;"></span></div>'
...
if (eye === 'normal') {
  eyePath = `
    <g>
      <circle cx="35" cy="50" r="10" fill="#FFF" stroke="#000" stroke-width="2"/>
      <circle cx="35" cy="50" r="5" fill="${eyeC}"/>
      <circle cx="37" cy="48" r="2" fill="#FFF"/>

      <circle cx="65" cy="50" r="10" fill="#FFF" stroke="#000" stroke-width="2"/>
  ...
  eyePath = '<path d="M34 50 C38 45 42 45 46 50" stroke="#000" stroke-width="2" fill="none"/>'+
            '<path d="M54 50 C58 45 62 45 66 50" stroke="#000" stroke-width="2" fill="none"/>';
}
else if (eye === 'wink') {
  eyePath = `
    <circle cx="40" cy="48" r="8" fill="#FFF" stroke="#000" stroke-width="2"/>
    <circle cx="40" cy="48" r="4" fill="${eyeC}"/>
    <circle cx="43" cy="45" r="2" fill="#FFF"/>

    <path d="M55 50 Q61 42 67 50" stroke="#000" stroke-width="3" fill="none"/>
  `;
}
else if (eye === 'glasses') {
  eyePath = `
    ...
    <circle cx="60" cy="48" r="8" fill="#FFF" stroke="#000" stroke-width="2"/>
    <circle cx="60" cy="48" r="4" fill="${eyeC}"/>

    <line x1="48" y1="48" x2="52" y2="48" stroke="#000" stroke-width="2"/>

    <line x1="32" y1="48" x2="28" y2="46" stroke="#000" stroke-width="2"/>
    <line x1="68" y1="48" x2="72" y2="46" stroke="#000" stroke-width="2"/>
  `;
}
else if (eye === 'angry') {
  eyePath = `
    ...
    <path d="M30,40 L50,50 L70,40" stroke="#000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
  `;
}
else if (eye === 'kawaii') {
  eyePath = `
    <circle cx="35" cy="50" r="12" fill="#FFF" stroke="#000" stroke-width="2"/>
    <circle cx="35" cy="50" r="7" fill="#000"/>
    <circle cx="32" cy="48" r="3" fill="#FFF"/>
    <circle cx="38" cy="52" r="1.5" fill="#FFF"/>

    <circle cx="65" cy="50" r="12" fill="#FFF" stroke="#000" stroke-width="2"/>
    <circle cx="65" cy="50" r="7" fill="#000"/>
    <circle cx="62" cy="48" r="3" fill="#FFF"/>
    <circle cx="68" cy="52" r="1.5" fill="#FFF"/>

    <path d="M28,43 Q31,40 34,43" stroke="#FFB3BA" stroke-width="1.5" fill="none"/>
    <path d="M58,43 Q61,40 64,43" stroke="#FFB3BA" stroke-width="1.5" fill="none"/>
  `;
}
else if (eye === 'sunglasses') {
  eyePath = `
    <ellipse cx="40" cy="48" rx="9" ry="6" fill="#333" stroke="#000" stroke-width="2"/>
    <ellipse cx="60" cy="48" rx="9" ry="6" fill="#333" stroke="#000" stroke-width="2"/>
    
    <path d="M49,48 Q50,46 51,48" stroke="#000" stroke-width="2" fill="none"/>

    <line x1="31" y1="48" x2="26" y2="42" stroke="#000" stroke-width="2"/>
    <line x1="69" y1="48" x2="72" y2="42" stroke="#000" stroke-width="2"/>
  `;
}
else if (eye === 'crying') {
  eyePath = `
    ...
    <circle cx="37" cy="52" r="1.5" fill="#FFF"/>
    <path d="M35 60 C33 65 37 65 35 70" stroke="#00f" stroke-width="2" fill="none"/>

    <circle cx="65" cy="50" r="10" fill="#FFF" stroke="#000" stroke-width="2"/>
    <circle cx="65" cy="50" r="5" fill="${eyeC}"/>
    <circle cx="63" cy="48" r="2" fill="#FFF"/>
    <circle cx="67" cy="52" r="1.5" fill="#FFF"/>
    <path d="M65 60 C63 65 67 65 65 70" stroke="#00f" stroke-width="2" fill="none"/>
  `;
}
  ...
  hairPath = '<path d="M20,60 C15,20 20,20 40,25 80,20 85,45 80,60 ' + 
  'M22,28 Q20,23 25,18 M25,15 Q30,25 25,20 M28,32 Q33,27 28,22 ' +
  'M35,25 Q40,20 35,15 M45,20 Q50,15 45,10 M55,20 Q60,15 55,10 ' +
  'M65,25 Q70,20 65,15 M72,28 Q77,23 72,18 M75,30 Q80,25 75,20 M78,32 Q83,27 78,22 ' +
  'M40,18 Q45,13 40,8 M50,15 Q55,10 50,5 M60,18 Q65,13 60,8' +
  '" fill="none" stroke="' + hairC + '" stroke-width="10" stroke-linecap="round"/>';
}
  else if (hair === 'ponytail') {
    hairPath = '<path d="M15,80 C15,45 20,15 50,10 80,15 85,45 85,80 C75,40 70,30 50,30 30,30 25,40 15,80 Z" fill="'+hairC+'"/>'
    + '<path d="M35,15 Q30,10 25,15 Q30,20 35,15 M45,12 Q40,7 35,12 Q40,17 45,12 M55,12 Q50,7 45,12 Q50,17 55,12 M65,15 Q60,10 55,15 Q60,20 65,15" fill="none" stroke="'+hairC+'" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>';
}
